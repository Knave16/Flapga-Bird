...
set_property IOSTANDARD LVCMOS33 [get_ports {timescore[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {timescore[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {timescore[0]}]
set_property PACKAGE_PIN U15 [get_ports {timescore[2]}]
set_property PACKAGE_PIN W18 [get_ports {timescore[1]}]
set_property PACKAGE_PIN V19 [get_ports {timescore[0]}]

set_property PACKAGE_PIN T18 [get_ports test]
